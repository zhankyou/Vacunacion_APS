...
class ETLVacunacion:
    ...
    def procesar(self):
        ...
        while True:
            ...
            resp = self.session.get(f"{self.base_url}/export/entries/{self.project_slug}",
                                    params={'form_ref': form_ref, 'format': 'csv', 'per_page': 500, 'page': pagina})
            if resp.status_code != 200 or len(resp.text.splitlines()) <= 1: break
...
# =====================================================================
# CLASE LOGICA: EXPORTACIÓN Y MAPEO SEMÁNTICO EN EXCEL
# =====================================================================
